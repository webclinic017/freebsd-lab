...
* 2. Don't make that in gnome, use ttys, Please -_- my laptop always sleep with gnome -_-

Notes
....
`$make buildworld` before you tried building the kernel
....



# Chapter 9 from FreeBSD developers-handbook
